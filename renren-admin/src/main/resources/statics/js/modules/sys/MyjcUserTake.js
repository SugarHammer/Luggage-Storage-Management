$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'sys/JcUserDeposit/MylistTake',
        datatype: "json",
        colModel: [
            ...
            { label: '柜子状态', name: 'luggageStu', index: 'luggageStu', width: 80,},
            ...
            { label: '操作', name: 'state', index: 'state', width: 50, edittype:"button",
                formatter: function (value, grid, rows, state) {
                    if(rows.luggageStu=="物品已取出"){
                        return '<a  href="javascript:void(0);"  style="color:#909d93">取出物品</a>';
                    }else {
                        return '<a  href="javascript:void(0);" id="mylink" style="color:#3cbd58" onclick="modify(\''+ rows.id+ '\');">取出物品</a>';
                    }
